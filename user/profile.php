            ...
            <div class="card-body">
              ...
              <form class="row g-3" action="actions/profile_edit_action.php" method="post">
                ...
                <div class="col-6">
                  ...
                  <input type="text" class="form-control" name="userBusinessName" value="<?php echo isset($row) ? $row['user_b_name'] : ''; ?>" require>
                </div>
                <div class="col-6">
                  <label for="inputEmail4" class="form-label">Address</label>
                  <input type="text" class="form-control" name="userAddress" value="<?php echo isset($row) ? $row['user_address'] : ''; ?>" require>
                </div>
                <div class="col-6">
                  <label for="inputEmail4" class="form-label">State</label>
                  <input type="text" class="form-control" name="userState" value="<?php echo isset($row) ? $row['user_state'] : ''; ?>" require>
                </div>
                <div class="col-6">
                  <label for="inputEmail4" class="form-label">Postcode</label>
                  <input type="text" class="form-control" name="userPostcode" value="<?php echo isset($row) ? $row['user_postcode'] : ''; ?>" require>
                </div>
                <div class="col-6">
                  <label for="inputEmail4" class="form-label">Contact Number</label>
                  <input type="phone" class="form-control" name="userPhone" value="<?php echo isset($row) ? $row['user_phone'] : ''; ?>" require>
                </div>
                <div class="col-6">
                  <label for="inputPassword4" class="form-label">Password</label>
                  <input type="password" min="8" max="10" class="form-control" name="userPassword" value="<?php echo base64_decode($row['user_password']); ?>" required>
                </div>
                <!--  -->
