...
<head>
  ...
  <title>Edit Project - Print & Track</title>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              ?>
              <!-- Vertical Form -->
              <form class="row g-3" action="actions/project_edit_action.php" method="POST">
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Supplier</label>
                  <input type="hidden" name="id" value="<?php echo isset($row) ? $row['project_id'] : ''; ?>">
                ...
                <div class="col-12">
                  <label for="inputAddress" class="form-label">Archived</label>
                  <select class="form-select" name="archived" aria-label="Floating label select example">
                        <option selected>Select menu</option>
                        <option value="0" <?php if (isset($row) && $row['archived'] == 0) { echo 'selected'; } ?>>Archieved</option>
                        <option value="1" <?php if (isset($row) && $row['archived'] == 1) { echo 'selected'; } ?>>Unarchieved</option>
                      </select>
                </div>
